...
<body>
    <script type="text/javascript" src="src/main/resources/static/static/scripts/verifyPassword.js"></script>
...
<!-- INCLUDE A BOX TO SPECIFY PASSWORD REQUIREMENTS-->
    <div style=" height: max-content; padding: 120px; text-align: center; display: flex; justify-content: center;">
        ...
        <div id="container" style="width: 1000px; height: 500px; background-color: rgb(150,150,150); 
            ...
            <br/>
            <form:form onsubmit="console.log('Helloworld'); return verifyPassword()" action="./createUser"  method="post" modelAttribute="user">
                <div>
